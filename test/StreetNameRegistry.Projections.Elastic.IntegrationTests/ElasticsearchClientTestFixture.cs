namespace StreetNameRegistry.Projections.Elastic.IntegrationTests
{
    ...
    public class ElasticsearchClientTestFixture : IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            _dockerService = DockerComposer.Compose("elastic.yml", "streetname-elastic-integration-tests");
        ...
        {
            var index = new StreetNameListElasticIndex(Client, new ElasticIndexOptions
            {
                Name = name
            });
