namespace StreetNameRegistry.Tests.BackOffice.Lambda.WhenRetiringStreetName
{
    using System;
    ...
    public sealed class GivenMunicipalityExists : BackOfficeLambdaTest
    {
        ...
        [Fact]
        public async Task ThenStreetNameWasRetired()
        {
            // Arrange
            ...
            var handler = new RetireStreetNameLambdaHandler(
        ...
        public async Task WhenStreetNameHasInvalidStatus_ThenTicketingErrorIsExpected()
        {
            ...
            var sut = new RetireStreetNameLambdaHandler(
                Container.Resolve<IConfiguration>(),
                new FakeRetryPolicy(),
                ticketing.Object,
            ...
            ticketing.Verify(x =>
                x.Error(
                    It.IsAny<Guid>(),
                    new TicketError("Deze actie is enkel toegestaan op straatnamen met status 'inGebruik'.", "StraatnaamVoorgesteldOfAfgekeurd"),
                    CancellationToken.None));
        }
