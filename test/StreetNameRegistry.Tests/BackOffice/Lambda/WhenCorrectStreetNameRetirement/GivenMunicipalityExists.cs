namespace StreetNameRegistry.Tests.BackOffice.Lambda.WhenCorrectStreetNameRetirement
{
    ...
    public sealed class GivenMunicipalityExists : BackOfficeLambdaTest
    {
        ...
        public async Task ThenStreetNameRetirementWasCorrected()
        {
            ...
            var handler = new CorrectStreetNameRetirementLambdaHandler(
            ...
            //Act
            await handler.Handle(new CorrectStreetNameRetirementLambdaRequest(municipalityId, new CorrectStreetNameRetirementSqsRequest
            {
                Request = new CorrectStreetNameRetirementRequest { PersistentLocalId = streetNamePersistentLocalId },
        ...
        public async Task WhenStreetNameHasInvalidStatus_ThenTicketingErrorIsExpected()
        {
            ...
            var sut = new CorrectStreetNameRetirementLambdaHandler(
                Container.Resolve<IConfiguration>(),
                new FakeRetryPolicy(),
                ticketing.Object,
        ...
        public async Task WhenIdempotencyException_ThenTicketingCompleteIsExpected()
        {
            ...
            // Act
            await sut.Handle(new CorrectStreetNameRetirementLambdaRequest(municipalityId, new CorrectStreetNameRetirementSqsRequest
            {
                Request = new CorrectStreetNameRetirementRequest { PersistentLocalId = streetNamePersistentLocalId },
                TicketId = Guid.NewGuid(),
                Metadata = new Dictionary<string, object?>(),
