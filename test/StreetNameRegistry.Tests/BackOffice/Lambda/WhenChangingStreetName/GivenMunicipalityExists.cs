namespace StreetNameRegistry.Tests.BackOffice.Lambda.WhenChangingStreetName
{
    using System;
    ...
    public sealed class GivenMunicipalityExists : BackOfficeLambdaTest
    {
        ...
        [Fact]
        public async Task ThenStreetNameNamesWereChangeed()
        {
            // Arrange
            ...
            var handler = new ChangeStreetNameNamesHandler(
            ...
            //Act
            await handler.Handle(new ChangeStreetNameNamesLambdaRequest(municipalityId, new ChangeStreetNameNamesSqsRequest
            {
                Request = new ChangeStreetNameNamesRequest
                {
        ...
        public async Task WhenStreetNameNameAlreadyExistsException_ThenTicketingErrorIsExpected()
        {
            ...
            var sut = new ChangeStreetNameNamesHandler(
                Container.Resolve<IConfiguration>(),
                new FakeRetryPolicy(),
                ticketing.Object,
            ...
            // Act
            await sut.Handle(new ChangeStreetNameNamesLambdaRequest(Guid.NewGuid().ToString(), new ChangeStreetNameNamesSqsRequest
            {
                Request = new ChangeStreetNameNamesRequest { Straatnamen = new Dictionary<Taal, string>() },
                TicketId = Guid.NewGuid(),
                Metadata = new Dictionary<string, object?>(),
                ProvenanceData = Fixture.Create<ProvenanceData>()
            }), CancellationToken.None);
        ...
        public async Task WhenIdempotencyException_ThenTicketingCompleteIsExpected()
        {
            ...
            // Act
            await sut.Handle(new ChangeStreetNameNamesLambdaRequest(municipalityId, new ChangeStreetNameNamesSqsRequest
            {
                Request = new ChangeStreetNameNamesRequest { Straatnamen = new Dictionary<Taal, string>() },
                PersistentLocalId = streetNamePersistentLocalId,
                TicketId = Guid.NewGuid(),
