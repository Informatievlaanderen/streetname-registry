namespace StreetNameRegistry.Tests.BackOffice.Sqs
{
    ...
    public sealed class GivenStreetNameBackOfficeRemoveRequest : StreetNameRegistryTest
    {
        private readonly TestBackOfficeContext _backOfficeContext;

        public GivenStreetNameBackOfficeRemoveRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sqsRequest = new RemoveStreetNameSqsRequest
            {
                Request = new RemoveStreetNameRequest
                {
        ...
        public void WithNoMunicipalityFoundByStreetNamePersistentLocalId_ThrowsAggregateIdNotFound()
        {
            ...
            var act = async () => await sut.Handle(
                ...
                {
                    Request = Fixture.Create<RemoveStreetNameRequest>()
                }, CancellationToken.None);
