namespace StreetNameRegistry.Tests.BackOffice.Validators
{
    ...
    public sealed class StreetNameChangeNamesRequestValidatorTests
    {
        private readonly StreetNameChangeNamesRequestValidator _validator;

        public StreetNameChangeNamesRequestValidatorTests()
        {
            var consumerContext = new FakeConsumerContextFactory().CreateDbContext();
            _validator = new StreetNameChangeNamesRequestValidator(consumerContext);
        }

        [Fact]
        public void GivenEmptyStreetName_ThenReturnsExpectedMessage()
        {
            var result = _validator.TestValidate(new ChangeStreetNameNamesRequest()
            {
            ...
            result.ShouldHaveValidationErrorFor($"{nameof(ChangeStreetNameNamesRequest.Straatnamen)}[0]")
        ...
        public void GivenOneEmptyStreetName_ThenReturnsExpectedMessage()
        {
            ...
            result.ShouldHaveValidationErrorFor($"{nameof(ChangeStreetNameNamesRequest.Straatnamen)}[1]")
        ...
        public void GivenStreetNamesIsNull_ThenReturnsExpectedMessage()
        {
            ...
            result.ShouldHaveValidationErrorFor(nameof(ChangeStreetNameNamesRequest.Straatnamen))
