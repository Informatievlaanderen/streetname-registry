namespace StreetNameRegistry.Tests.ProjectionTests.Feed
{
    ...
    public sealed class StreetNameFeedProjectionsTests
    {
        ...
        public async Task WhenRemovedStreetNameWasMigratedToMunicipality_ThenFeedItemIsNotAddedAndDocumentIsAdded()
        {
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    document.Document.Status.Should().BeEquivalentTo(new StraatnaamStatus(StraatnaamStatusValue.Voorgesteld));
                    ...
                    ChangeFeedServiceMock.Verify(x => x.CreateCloudEventWithData(
                            ...
                            It.Is<List<BaseRegistriesCloudEventAttribute>>(attrs =>
                                ...
                                attrs.Any(a => a.Name == StreetNameAttributeNames.StatusName &&
                                               a.OldValue == null &&
                                               a.NewValue!.ToString() == document.Document.Status.Id)),
                ...
                .Then(async context =>
                {
                    ...
                    ChangeFeedServiceMock.Verify(x => x.CreateCloudEventWithData(
                            ...
                            It.Is<List<BaseRegistriesCloudEventAttribute>>(attrs =>
                                ...
                                attrs.Any(a => a.Name == StreetNameAttributeNames.StatusName &&
                                               a.OldValue == null &&
                                               a.NewValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.Voorgesteld).Id)),
        ...
        public async Task WhenStreetNameWasApproved_ThenFeedItemIsAddedAndDocumentUpdated()
        {
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    document.Document.Status.Should().BeEquivalentTo(new StraatnaamStatus(StraatnaamStatusValue.InGebruik));
                    ...
                    ChangeFeedServiceMock.Verify(x => x.CreateCloudEventWithData(
                            ...
                            It.Is<List<BaseRegistriesCloudEventAttribute>>(attrs =>
                                attrs.Any(a => a.Name == StreetNameAttributeNames.StatusName
                                               && a.OldValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.Voorgesteld).Id
                                               && a.NewValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.InGebruik).Id)),
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    ChangeFeedServiceMock.Verify(x => x.CreateCloudEventWithData(
                            ...
                            It.Is<List<BaseRegistriesCloudEventAttribute>>(attrs =>
                                attrs.Any(a => a.Name == StreetNameAttributeNames.StatusName
                                               && a.OldValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.InGebruik).Id
                                               && a.NewValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.Voorgesteld).Id)),
        ...
        public async Task WhenStreetNameWasRejected_ThenFeedItemIsAddedAndDocumentUpdated()
        {
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    document.Document.Status.Should().BeEquivalentTo(new StraatnaamStatus(StraatnaamStatusValue.Afgekeurd));
                    ...
                    ChangeFeedServiceMock.Verify(x => x.CreateCloudEventWithData(
                            ...
                            It.Is<List<BaseRegistriesCloudEventAttribute>>(attrs =>
                                attrs.Any(a => a.Name == StreetNameAttributeNames.StatusName
                                               && a.OldValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.Voorgesteld).Id
                                               && a.NewValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.Afgekeurd).Id)),
        ...
        [Fact]
        public async Task WhenStreetNameWasRejectedBecauseOfMunicipalityMergerWithNoNewPersistentLocalId_ThenFeedItemIsAddedAndDocumentUpdated()
        {
            _fixture.Register(() => new Names(_fixture.CreateMany<StreetNameName>(2).ToList()));
            var streetNameWasProposedV2 = _fixture.Create<StreetNameWasProposedV2>();
            var streetNameWasRejectedBecauseOfMunicipalityMerger = new StreetNameWasRejectedBecauseOfMunicipalityMerger(
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    ChangeFeedServiceMock.Verify(x => x.CreateCloudEvent(
                            ...
                            StreetNameEventTypes.TransformV1,
                            It.IsAny<string>(),
                            It.IsAny<StreetNameCloudTransformEvent>(),
                            It.IsAny<Uri>(),
                            It.IsAny<string>(),
                            It.IsAny<string>()),
                        Times.Never);
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    ChangeFeedServiceMock.Verify(x => x.CreateCloudEventWithData(
                            ...
                            It.Is<List<BaseRegistriesCloudEventAttribute>>(attrs =>
                                attrs.Any(a => a.Name == StreetNameAttributeNames.StatusName
                                               && a.OldValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.Afgekeurd).Id
                                               && a.NewValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.Voorgesteld).Id)),
        ...
        public async Task WhenStreetNameWasRetiredV2_ThenFeedItemIsAddedAndDocumentUpdated()
        {
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    document.Document.Status.Should().BeEquivalentTo(new StraatnaamStatus(StraatnaamStatusValue.Gehistoreerd));
                    ...
                    ChangeFeedServiceMock.Verify(x => x.CreateCloudEventWithData(
                            ...
                            It.Is<List<BaseRegistriesCloudEventAttribute>>(attrs =>
                                attrs.Any(a => a.Name == StreetNameAttributeNames.StatusName
                                               && a.OldValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.InGebruik).Id
                                               && a.NewValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.Gehistoreerd).Id)),
        ...
        [Fact]
        public async Task WhenStreetNameWasRetiredBecauseOfMunicipalityMergerWithNoNewPersistentLocalId_ThenFeedItemIsAddedAndDocumentUpdated()
        {
            _fixture.Register(() => new Names(_fixture.CreateMany<StreetNameName>(2).ToList()));
            var streetNameWasProposedV2 = _fixture.Create<StreetNameWasProposedV2>();
            var streetNameWasApproved = _fixture.Create<StreetNameWasApproved>();
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    ChangeFeedServiceMock.Verify(x => x.CreateCloudEventWithData(
                            ...
                            It.Is<List<BaseRegistriesCloudEventAttribute>>(attrs =>
                                attrs.Any(a => a.Name == StreetNameAttributeNames.StatusName
                                               && a.OldValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.Gehistoreerd).Id
                                               && a.NewValue!.ToString() == new StraatnaamStatus(StraatnaamStatusValue.InGebruik).Id)),
