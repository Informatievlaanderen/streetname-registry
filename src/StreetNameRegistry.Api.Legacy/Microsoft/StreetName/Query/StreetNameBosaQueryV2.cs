namespace StreetNameRegistry.Api.Legacy.Microsoft.StreetName.Query
{
    using System;
    ...
    using StreetNameRegistry.Api.Legacy.Convertors;
    ...
    using StreetNameRegistry.Projections.Legacy.Microsoft.StreetNameNameV2;
    using StreetNameRegistry.Projections.Syndication.Microsoft;
    using StreetNameRegistry.Projections.Syndication.Municipality;

    public sealed class StreetNameBosaQueryV2
    {
        ...
        private async Task<IEnumerable<StreetNameBosaItemResponse>> TransformAsync(
            ...
            IReadOnlyCollection<Projections.Syndication.Microsoft.Municipality.MunicipalityLatestItem> municipalities,
            Language? language,
        ...
        private static IEnumerable<GeografischeNaam> GetMunicipalityNames(Projections.Syndication.Microsoft.Municipality.MunicipalityLatestItem municipality)
        {
    ...
    public sealed class StreetNameNameFilterV2
    {
