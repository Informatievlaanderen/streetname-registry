namespace StreetNameRegistry.Projections.Wfs.Microsoft.StreetNameHelperV2
{
    using System;
    ...
    public sealed class StreetNameHelperV2Projections: ConnectedProjection<WfsContext>
    {
