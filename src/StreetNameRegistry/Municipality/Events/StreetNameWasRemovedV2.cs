namespace StreetNameRegistry.Municipality.Events
{
    ...
    public sealed class StreetNameWasRemovedV2 : IMunicipalityEvent, IHasPersistentLocalId
    {
        public const string EventName = "StreetNameWasRemovedV2"; // BE CAREFUL CHANGING THIS!!
        ...
        [JsonConstructor]
        private StreetNameWasRemovedV2(
            Guid municipalityId,
