namespace StreetNameRegistry.Projections.LastChangedList.Console.Infrastructure
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Log.Information("Initializing StreetNameRegistry.Projections.LastChangedList.Console");
            ...
            Log.Information("Starting StreetNameRegistry.Projections.LastChangedList.Console");
