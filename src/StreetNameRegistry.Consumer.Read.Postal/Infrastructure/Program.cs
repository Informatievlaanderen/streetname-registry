namespace StreetNameRegistry.Consumer.Read.Postal.Infrastructure
{
    ...
    public sealed class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Log.Information("Starting StreetNameRegistry.Consumer.Read.Postal");
                ...
                .ConfigureContainer<ContainerBuilder>((hostContext, builder) =>
                {
                    ...
                    builder
                        .Register(c =>
                        {
                            ...
                            var consumerGroupId = $"StreetNameRegistry.ConsumerPostalItem.{topic}{suffix}";
                            ...
                            {
                                using var ctx = c.Resolve<ConsumerPostalContext>();

                                if (ctx.PostalConsumerItems.Any())
                                {
                                    throw new InvalidOperationException($"Cannot set Kafka offset to {offset} because {nameof(ctx.PostalConsumerItems)} has data.");
                                }
