namespace StreetNameRegistry.Projections.Legacy.Microsoft.StreetNameName
{
    using System;
    ...
    public sealed class StreetNameName
    {
    ...
    public sealed class StreetNameNameConfiguration : IEntityTypeConfiguration<StreetNameName>
    {
