namespace StreetNameRegistry.Api.Oslo.Microsoft.StreetName.Detail
{
    ...
    public abstract class OsloDetailHandlerBase : IRequestHandler<OsloDetailRequest, StreetNameOsloResponse>
    {
        ...
        private static KeyValuePair<Taal, string> GetDefaultMunicipalityName(Projections.Syndication.Microsoft.Municipality.MunicipalityLatestItem? municipality)
        {
