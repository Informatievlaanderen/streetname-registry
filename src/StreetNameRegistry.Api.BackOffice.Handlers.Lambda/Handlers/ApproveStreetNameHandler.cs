namespace StreetNameRegistry.Api.BackOffice.Handlers.Lambda.Handlers
{
    ...
    public sealed class ApproveStreetNameHandler : StreetNameLambdaHandler<ApproveStreetNameLambdaRequest>
    {
        ...
        protected override async Task<object> InnerHandle(ApproveStreetNameLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, ApproveStreetNameLambdaRequest request)
        {
            return exception switch
            {
                StreetNameHasInvalidStatusException =>
                    ValidationErrors.ApproveStreetName.InvalidStatus.ToTicketError(),
